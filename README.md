...
### weBot (depricated)
The `weBot` repository is a Python-based project aimed at developing a web bot capable of simulating human-like interactions on social media platforms, although it is currently non-functional and not deployed due to terms of service violations. Repository: https://github.com/MarcoBetti1/weBot
